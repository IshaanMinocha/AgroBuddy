    ...
    <Modal
      ...
      <View style={styles.headerContainer}>
        ...
        <Pressable
          ...
          onPressOut={async () => {
            await handleStopRecording();  // Ensure recording stops first
            const transcribedText = await handleTranscribe();  // Wait for transcription
            await handleProcessQuery();  // Process the query
            await handleSpeakAnswerEleven();  // Speak the answer
          }}
